...
namespace kil
{
    ...
    static std::wstring GetExt(const std::wstring& filepath)
    {
    ...
    //L"image/tiff"
    static BOOL SaveImage(LPCWSTR lpszFormat, LPCWSTR lpszFilePath, Gdiplus::Bitmap& img)
    {
        CLSID encoderClsid;
    ...
    static std::wstring GetFormat(LPCWSTR szOutputPath)
    {
    ...
    static bool CopyTextureFile_GdiPlus_Imp(LPCWSTR szInputPath, LPCWSTR szOutputPath)
    {
    ...
    static bool CopyTextureFile_GdiPlus_Imp(const std::string& orgPath, const std::string& dstPath)
    {
#ifdef _WIN32
